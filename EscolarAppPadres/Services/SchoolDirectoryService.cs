...
namespace EscolarAppPadres.Services
{
    class SchoolDirectoryService
    {
        ...
        public async Task<ResponseModel<SchoolDirectory>?> GetDirectoryAsync(string token)
        {
            ...
            try
            {
                ...
                var url = $"{ApiRoutes.BaseUrl}{ApiRoutes.Services.GetSchoolDirectory}";
                ...
                {
                    return new ResponseModel<SchoolDirectory>
                    {
                        IsClientError = true,
                ...
                return new ResponseModel<SchoolDirectory>
                {
                    ...
                    Data = tempResponse.Data ?? new List<SchoolDirectory>()
                };
            }
        ...
        private class TempApiResponse
        {
            ...
            public List<SchoolDirectory> Data { get; set; }
        }
    }
}
