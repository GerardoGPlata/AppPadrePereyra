...
{
    public class InscripcionDto : INotifyPropertyChanged
    {
        ...
        public decimal ImporteCalculado => SaldoTotal + InteresTotal;
        ...
        public int IsInscripcion { get; set; }
        ...
        public decimal RecargoPorVencimiento { get; set; }
        ...
        public decimal SaldoFondoOrfandad { get; set; }
        public int SubConceptoInscripcionId { get; set; }

        // Propiedades calculadas para UI
        public string TipoDocumentoTexto => "Inscripción";
